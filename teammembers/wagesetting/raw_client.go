...
func (r *RawClient) Get(
...
) (*core.Response[*v2.GetWageSettingResponse], error) {
	...
	return &core.Response[*v2.GetWageSettingResponse]{
...
func (r *RawClient) Update(
	...
	opts ...option.RequestOption,
) (*core.Response[*v2.UpdateWageSettingResponse], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	return &core.Response[*v2.UpdateWageSettingResponse]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
