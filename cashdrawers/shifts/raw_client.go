...
func (r *RawClient) Get(
...
) (*core.Response[*square.GetCashDrawerShiftResponse], error) {
	...
	var response *square.GetCashDrawerShiftResponse
	...
	return &core.Response[*square.GetCashDrawerShiftResponse]{
