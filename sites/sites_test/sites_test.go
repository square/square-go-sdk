...
func TestSitesListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Sites.List(
		context.TODO(),
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestSitesListWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestSitesListWithWireMock", "GET", "/v2/sites", nil, 1)
}
