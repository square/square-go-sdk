...
type AccumulateLoyaltyPointsRequest struct {
	...
	AccumulatePoints *v505.LoyaltyEventAccumulatePoints `json:"accumulate_points" url:"-"`
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (a *AccumulateLoyaltyPointsRequest) SetAccumulatePoints(accumulatePoints *v505.LoyaltyEventAccumulatePoints) {
...
type AdjustLoyaltyPointsRequest struct {
	...
	AdjustPoints *v505.LoyaltyEventAdjustPoints `json:"adjust_points" url:"-"`
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (a *AdjustLoyaltyPointsRequest) SetAdjustPoints(adjustPoints *v505.LoyaltyEventAdjustPoints) {
...
type CreateLoyaltyAccountRequest struct {
	...
	LoyaltyAccount *v505.LoyaltyAccount `json:"loyalty_account" url:"-"`
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (c *CreateLoyaltyAccountRequest) SetLoyaltyAccount(loyaltyAccount *v505.LoyaltyAccount) {
...
type SearchLoyaltyAccountsRequest struct {
	...
	Query *v505.SearchLoyaltyAccountsRequestLoyaltyAccountQuery `json:"query,omitempty" url:"-"`
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *SearchLoyaltyAccountsRequest) SetQuery(query *v505.SearchLoyaltyAccountsRequestLoyaltyAccountQuery) {
	s.Query = query
