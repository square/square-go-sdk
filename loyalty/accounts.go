...
type AccumulateLoyaltyPointsRequest struct {
	...
	AccumulatePoints *v5.LoyaltyEventAccumulatePoints `json:"accumulate_points" url:"-"`
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (a *AccumulateLoyaltyPointsRequest) SetAccumulatePoints(accumulatePoints *v5.LoyaltyEventAccumulatePoints) {
...
type AdjustLoyaltyPointsRequest struct {
	...
	AdjustPoints *v5.LoyaltyEventAdjustPoints `json:"adjust_points" url:"-"`
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (a *AdjustLoyaltyPointsRequest) SetAdjustPoints(adjustPoints *v5.LoyaltyEventAdjustPoints) {
...
type CreateLoyaltyAccountRequest struct {
	...
	LoyaltyAccount *v5.LoyaltyAccount `json:"loyalty_account" url:"-"`
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (c *CreateLoyaltyAccountRequest) SetLoyaltyAccount(loyaltyAccount *v5.LoyaltyAccount) {
...
type SearchLoyaltyAccountsRequest struct {
	...
	Query *v5.SearchLoyaltyAccountsRequestLoyaltyAccountQuery `json:"query,omitempty" url:"-"`
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *SearchLoyaltyAccountsRequest) SetQuery(query *v5.SearchLoyaltyAccountsRequestLoyaltyAccountQuery) {
	s.Query = query
