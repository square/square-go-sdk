...
type AccumulateLoyaltyPointsRequest struct {
	...
	AccumulatePoints *v40.LoyaltyEventAccumulatePoints `json:"accumulate_points,omitempty" url:"-"`
...
type AdjustLoyaltyPointsRequest struct {
	...
	AdjustPoints *v40.LoyaltyEventAdjustPoints `json:"adjust_points,omitempty" url:"-"`
...
type CreateLoyaltyAccountRequest struct {
	...
	LoyaltyAccount *v40.LoyaltyAccount `json:"loyalty_account,omitempty" url:"-"`
...
type SearchLoyaltyAccountsRequest struct {
	...
	Query *v40.SearchLoyaltyAccountsRequestLoyaltyAccountQuery `json:"query,omitempty" url:"-"`
