...
func (c *Client) Get(
	...
	endpointURL := internal.EncodeURL(baseURL+"/v2/loyalty/programs/%v", programID)
...
func (c *Client) Calculate(
	...
	endpointURL := internal.EncodeURL(baseURL+"/v2/loyalty/programs/%v/calculate", programID)
