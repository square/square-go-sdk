...
type CreateLoyaltyPromotionRequest struct {
	...
	LoyaltyPromotion *v5.LoyaltyPromotion `json:"loyalty_promotion" url:"-"`
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (c *CreateLoyaltyPromotionRequest) SetLoyaltyPromotion(loyaltyPromotion *v5.LoyaltyPromotion) {
...
type ListPromotionsRequest struct {
	...
	Status *v5.LoyaltyPromotionStatus `json:"-" url:"status,omitempty"`
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (l *ListPromotionsRequest) SetStatus(status *v5.LoyaltyPromotionStatus) {
	l.Status = status
