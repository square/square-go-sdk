...
type CalculateLoyaltyPointsRequest struct {
	...
	TransactionAmountMoney *v5.Money `json:"transaction_amount_money,omitempty" url:"-"`
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (c *CalculateLoyaltyPointsRequest) SetTransactionAmountMoney(transactionAmountMoney *v5.Money) {
