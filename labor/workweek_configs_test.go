...
func TestSettersUpdateWorkweekConfigRequest(t *testing.T) {
	t.Run("SetID", func(t *testing.T) {
		obj := &UpdateWorkweekConfigRequest{}
...
func TestSettersMarkExplicitUpdateWorkweekConfigRequest(t *testing.T) {
...
func TestSettersListWorkweekConfigsRequest(t *testing.T) {
	t.Run("SetLimit", func(t *testing.T) {
		obj := &ListWorkweekConfigsRequest{}
...
func TestSettersMarkExplicitListWorkweekConfigsRequest(t *testing.T) {
