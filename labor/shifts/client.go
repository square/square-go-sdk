...
func (c *Client) Create(
	...
	var response *v40.CreateShiftResponse
...
func (c *Client) Search(
	...
	opts ...option.RequestOption,
) (*v40.SearchShiftsResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *v40.SearchShiftsResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
...
func (c *Client) Get(
	...
	var response *v40.GetShiftResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
...
func (c *Client) Update(
	...
	var response *v40.UpdateShiftResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
...
func (c *Client) Delete(
	...
	var response *v40.DeleteShiftResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
