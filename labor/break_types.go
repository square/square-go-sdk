...
type CreateBreakTypeRequest struct {
	...
	BreakType *v505.BreakType `json:"break_type" url:"-"`
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (c *CreateBreakTypeRequest) SetBreakType(breakType *v505.BreakType) {
...
// SetBreakType sets the BreakType field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (u *UpdateBreakTypeRequest) SetBreakType(breakType *v505.BreakType) {
