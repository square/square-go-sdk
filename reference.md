...
**includeOptions:** `*square.IncludeOptions` — Options to include related resources in the response.
...
## Inventory
<details><summary><code>client.Inventory.ListInventoryAdjustmentReasons() -> *square.ListInventoryAdjustmentReasonsResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.Inventory.CreateInventoryAdjustmentReason(request) -> *square.CreateInventoryAdjustmentReasonResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.Inventory.DeleteInventoryAdjustmentReason(request) -> *square.DeleteInventoryAdjustmentReasonResponse</code></summary>
<dl>
<dd>
...
**reasonID:** `*square.InventoryAdjustmentReasonID` — The identifier of the custom inventory adjustment reason to soft delete.
...
<details><summary><code>client.Inventory.RestoreInventoryAdjustmentReason(request) -> *square.RestoreInventoryAdjustmentReasonResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.Inventory.RetrieveInventoryAdjustmentReason(request) -> *square.RetrieveInventoryAdjustmentReasonResponse</code></summary>
<dl>
<dd>
...
**reasonID:** `*square.InventoryAdjustmentReasonID` — The identifier of the inventory adjustment reason to retrieve.
...
<details><summary><code>client.Inventory.UpdateInventoryAdjustmentReason(request) -> *square.UpdateInventoryAdjustmentReasonResponse</code></summary>
<dl>
<dd>
...
**reasonID:** `*square.InventoryAdjustmentReasonID` — The identifier of the custom inventory adjustment reason to update.
...
<details><summary><code>client.Inventory.UpdateInventoryAdjustment(request) -> *square.UpdateInventoryAdjustmentResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.Inventory.GetTransfer(TransferID) -> error</code></summary>
<dl>
<dd>
