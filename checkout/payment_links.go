...
type CreatePaymentLinkRequest struct {
	...
	QuickPay *v5.QuickPay `json:"quick_pay,omitempty" url:"-"`
	...
	Order *v5.Order `json:"order,omitempty" url:"-"`
	// Describes optional fields to add to the resulting checkout page.
	// For more information,
	// see [Optional Checkout Configurations](https://developer.squareup.com/docs/checkout-api/optional-checkout-configurations).
	CheckoutOptions *v5.CheckoutOptions `json:"checkout_options,omitempty" url:"-"`
	...
	PrePopulatedData *v5.PrePopulatedData `json:"pre_populated_data,omitempty" url:"-"`
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (c *CreatePaymentLinkRequest) SetQuickPay(quickPay *v5.QuickPay) {
	c.QuickPay = quickPay
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (c *CreatePaymentLinkRequest) SetOrder(order *v5.Order) {
	c.Order = order
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (c *CreatePaymentLinkRequest) SetCheckoutOptions(checkoutOptions *v5.CheckoutOptions) {
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (c *CreatePaymentLinkRequest) SetPrePopulatedData(prePopulatedData *v5.PrePopulatedData) {
...
type UpdatePaymentLinkRequest struct {
	...
	PaymentLink *v5.PaymentLink `json:"payment_link" url:"-"`
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (u *UpdatePaymentLinkRequest) SetPaymentLink(paymentLink *v5.PaymentLink) {
