...
type CreateDeviceCodeRequest struct {
	...
	DeviceCode *v4.DeviceCode `json:"device_code" url:"-"`
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (c *CreateDeviceCodeRequest) SetDeviceCode(deviceCode *v4.DeviceCode) {
...
type ListCodesRequest struct {
	...
	ProductType *v4.ProductType `json:"-" url:"product_type,omitempty"`
	// If specified, returns DeviceCodes with the specified statuses.
	// Returns DeviceCodes of status `PAIRED` and `UNPAIRED` if empty.
	Status *v4.DeviceCodeStatus `json:"-" url:"status,omitempty"`
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (l *ListCodesRequest) SetProductType(productType *v4.ProductType) {
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (l *ListCodesRequest) SetStatus(status *v4.DeviceCodeStatus) {
	l.Status = status
