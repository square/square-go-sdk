...
type BulkDeleteMerchantCustomAttributesRequest struct {
	...
	Values map[string]*v40.BulkDeleteMerchantCustomAttributesRequestMerchantCustomAttributeDeleteRequest `json:"values,omitempty" url:"-"`
}
...
type BulkUpsertMerchantCustomAttributesRequest struct {
	...
	Values map[string]*v40.BulkUpsertMerchantCustomAttributesRequestMerchantCustomAttributeUpsertRequest `json:"values,omitempty" url:"-"`
}
