...
import (
	...
	customattributedefinitions "github.com/square/square-go-sdk/v40/merchants/customattributedefinitions"
	customattributes "github.com/square/square-go-sdk/v40/merchants/customattributes"
...
func (c *Client) List(
	ctx context.Context,
	request *v40.MerchantsListRequest,
	opts ...option.RequestOption,
) (*core.Page[*v40.Merchant], error) {
	options := core.NewRequestOptions(opts...)
	...
	readPageResponse := func(response *v40.ListMerchantsResponse) *internal.PageResponse[*int, *v40.Merchant] {
		next := response.Cursor
		results := response.Merchant
		return &internal.PageResponse[*int, *v40.Merchant]{
			Next:    next,
			Results: results,
		}
	}
...
func (c *Client) Get(
	ctx context.Context,
	request *v40.MerchantsGetRequest,
	opts ...option.RequestOption,
) (*v40.GetMerchantResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *v40.GetMerchantResponse
