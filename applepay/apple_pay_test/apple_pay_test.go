...
func TestApplePayRegisterDomainWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.ApplePay.RegisterDomain(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestApplePayRegisterDomainWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestApplePayRegisterDomainWithWireMock", "POST", "/v2/apple-pay/domains", nil, 1)
}
