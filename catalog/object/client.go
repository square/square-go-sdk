...
func (c *Client) Upsert(
...
) (*v40.UpsertCatalogObjectResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *v40.UpsertCatalogObjectResponse
...
func (c *Client) Get(
	...
	opts ...option.RequestOption,
) (*v40.GetCatalogObjectResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *v40.GetCatalogObjectResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
...
func (c *Client) Delete(
	...
	opts ...option.RequestOption,
) (*v40.DeleteCatalogObjectResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *v40.DeleteCatalogObjectResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
