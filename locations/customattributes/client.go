...
func (c *Client) BatchDelete(
...
) (*v40.BulkDeleteLocationCustomAttributesResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *v40.BulkDeleteLocationCustomAttributesResponse
...
func (c *Client) BatchUpsert(
	...
	opts ...option.RequestOption,
) (*v40.BulkUpsertLocationCustomAttributesResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *v40.BulkUpsertLocationCustomAttributesResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
...
func (c *Client) List(
	...
	readPageResponse := func(response *v40.ListLocationCustomAttributesResponse) *internal.PageResponse[*string, *v40.CustomAttribute] {
...
func (c *Client) Get(
	...
	opts ...option.RequestOption,
) (*v40.RetrieveLocationCustomAttributeResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *v40.RetrieveLocationCustomAttributeResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
...
func (c *Client) Upsert(
	...
	opts ...option.RequestOption,
) (*v40.UpsertLocationCustomAttributeResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *v40.UpsertLocationCustomAttributeResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
...
func (c *Client) Delete(
	...
	opts ...option.RequestOption,
) (*v40.DeleteLocationCustomAttributeResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *v40.DeleteLocationCustomAttributeResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
