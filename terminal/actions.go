...
type CreateTerminalActionRequest struct {
	...
	Action *v5.TerminalAction `json:"action" url:"-"`
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (c *CreateTerminalActionRequest) SetAction(action *v5.TerminalAction) {
	c.Action = action
...
type SearchTerminalActionsRequest struct {
	...
	Query *v5.TerminalActionQuery `json:"query,omitempty" url:"-"`
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *SearchTerminalActionsRequest) SetQuery(query *v5.TerminalActionQuery) {
	s.Query = query
