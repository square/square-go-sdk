...
func (c *Client) Get(
	...
	endpointURL := internal.EncodeURL(baseURL+"/v2/terminals/refunds/%v", terminalRefundID)
...
func (c *Client) Cancel(
	...
	endpointURL := internal.EncodeURL(baseURL+"/v2/terminals/refunds/%v/cancel", terminalRefundID)
