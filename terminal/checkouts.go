...
type CreateTerminalCheckoutRequest struct {
	...
	Checkout *v5.TerminalCheckout `json:"checkout" url:"-"`
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (c *CreateTerminalCheckoutRequest) SetCheckout(checkout *v5.TerminalCheckout) {
	c.Checkout = checkout
...
type SearchTerminalCheckoutsRequest struct {
	...
	Query *v5.TerminalCheckoutQuery `json:"query,omitempty" url:"-"`
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *SearchTerminalCheckoutsRequest) SetQuery(query *v5.TerminalCheckoutQuery) {
	s.Query = query
