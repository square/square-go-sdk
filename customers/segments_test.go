...
func TestSettersGetSegmentsRequest(t *testing.T) {
...
func TestSettersMarkExplicitGetSegmentsRequest(t *testing.T) {
...
func TestSettersListSegmentsRequest(t *testing.T) {
	t.Run("SetCursor", func(t *testing.T) {
		obj := &ListSegmentsRequest{}
...
func TestSettersMarkExplicitListSegmentsRequest(t *testing.T) {
