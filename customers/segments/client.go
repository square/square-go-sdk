...
func (c *Client) List(
...
) (*core.Page[*v40.CustomerSegment], error) {
	options := core.NewRequestOptions(opts...)
	...
	readPageResponse := func(response *v40.ListCustomerSegmentsResponse) *internal.PageResponse[*string, *v40.CustomerSegment] {
		next := response.Cursor
		results := response.Segments
		return &internal.PageResponse[*string, *v40.CustomerSegment]{
			Next:    next,
			Results: results,
		}
	}
...
func (c *Client) Get(
	...
	opts ...option.RequestOption,
) (*v40.GetCustomerSegmentResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *v40.GetCustomerSegmentResponse
