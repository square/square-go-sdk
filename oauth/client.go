...
func (c *Client) RevokeToken(
	ctx context.Context,
	request *v40.RevokeTokenRequest,
	opts ...option.RequestOption,
) (*v40.RevokeTokenResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *v40.RevokeTokenResponse
...
func (c *Client) ObtainToken(
	ctx context.Context,
	request *v40.ObtainTokenRequest,
	opts ...option.RequestOption,
) (*v40.ObtainTokenResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *v40.ObtainTokenResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
...
func (c *Client) RetrieveTokenStatus(
	ctx context.Context,
	opts ...option.RequestOption,
) (*v40.RetrieveTokenStatusResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *v40.RetrieveTokenStatusResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
