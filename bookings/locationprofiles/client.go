...
func (c *Client) List(
...
) (*core.Page[*v40.LocationBookingProfile], error) {
	options := core.NewRequestOptions(opts...)
	...
	readPageResponse := func(response *v40.ListLocationBookingProfilesResponse) *internal.PageResponse[*string, *v40.LocationBookingProfile] {
		next := response.Cursor
		results := response.LocationBookingProfiles
		return &internal.PageResponse[*string, *v40.LocationBookingProfile]{
			Next:    next,
			Results: results,
		}
	}
