...
type BulkDeleteBookingCustomAttributesRequest struct {
	...
	Values map[string]*v505.BookingCustomAttributeDeleteRequest `json:"values" url:"-"`
...
func (b *BulkDeleteBookingCustomAttributesRequest) SetValues(values map[string]*v505.BookingCustomAttributeDeleteRequest) {
	b.Values = values
...
type BulkUpsertBookingCustomAttributesRequest struct {
	...
	Values map[string]*v505.BookingCustomAttributeUpsertRequest `json:"values" url:"-"`
...
// SetValues sets the Values field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (b *BulkUpsertBookingCustomAttributesRequest) SetValues(values map[string]*v505.BookingCustomAttributeUpsertRequest) {
	b.Values = values
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (u *UpsertBookingCustomAttributeRequest) SetCustomAttribute(customAttribute *v505.CustomAttribute) {
