...
import (
	...
	customattributedefinitions "github.com/square/square-go-sdk/v40/orders/customattributedefinitions"
	customattributes "github.com/square/square-go-sdk/v40/orders/customattributes"
	http "net/http"
	os "os"
)
...
func (c *Client) Create(
	ctx context.Context,
	request *v40.CreateOrderRequest,
	opts ...option.RequestOption,
) (*v40.CreateOrderResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *v40.CreateOrderResponse
...
func (c *Client) BatchGet(
	ctx context.Context,
	request *v40.BatchGetOrdersRequest,
	opts ...option.RequestOption,
) (*v40.BatchGetOrdersResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *v40.BatchGetOrdersResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
...
func (c *Client) Calculate(
	ctx context.Context,
	request *v40.CalculateOrderRequest,
	opts ...option.RequestOption,
) (*v40.CalculateOrderResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *v40.CalculateOrderResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
...
func (c *Client) Clone(
	ctx context.Context,
	request *v40.CloneOrderRequest,
	opts ...option.RequestOption,
) (*v40.CloneOrderResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *v40.CloneOrderResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
...
func (c *Client) Search(
	ctx context.Context,
	request *v40.SearchOrdersRequest,
	opts ...option.RequestOption,
) (*v40.SearchOrdersResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *v40.SearchOrdersResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
...
func (c *Client) Get(
	ctx context.Context,
	request *v40.OrdersGetRequest,
	opts ...option.RequestOption,
) (*v40.GetOrderResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *v40.GetOrderResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
...
func (c *Client) Update(
	ctx context.Context,
	request *v40.UpdateOrderRequest,
	opts ...option.RequestOption,
) (*v40.UpdateOrderResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *v40.UpdateOrderResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
...
func (c *Client) Pay(
	ctx context.Context,
	request *v40.PayOrderRequest,
	opts ...option.RequestOption,
) (*v40.PayOrderResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *v40.PayOrderResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
