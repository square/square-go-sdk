...
func TestSettersCreateOrderCustomAttributeDefinitionRequest(t *testing.T) {
	t.Run("SetIdempotencyKey", func(t *testing.T) {
		obj := &CreateOrderCustomAttributeDefinitionRequest{}
...
func TestSettersMarkExplicitCreateOrderCustomAttributeDefinitionRequest(t *testing.T) {
...
func TestSettersUpdateOrderCustomAttributeDefinitionRequest(t *testing.T) {
	t.Run("SetKey", func(t *testing.T) {
		obj := &UpdateOrderCustomAttributeDefinitionRequest{}
		var fernTestValueKey string
		obj.SetKey(fernTestValueKey)
		assert.Equal(t, fernTestValueKey, obj.Key)
		assert.NotNil(t, obj.explicitFields)
...
func TestSettersMarkExplicitUpdateOrderCustomAttributeDefinitionRequest(t *testing.T) {
	t.Run("SetKey_MarksExplicit", func(t *testing.T) {
		t.Parallel()
		// Arrange
		obj := &UpdateOrderCustomAttributeDefinitionRequest{}
