...
type BulkDeleteOrderCustomAttributesRequest struct {
	...
	Values map[string]*v5.BulkDeleteOrderCustomAttributesRequestDeleteCustomAttribute `json:"values" url:"-"`
...
func (b *BulkDeleteOrderCustomAttributesRequest) SetValues(values map[string]*v5.BulkDeleteOrderCustomAttributesRequestDeleteCustomAttribute) {
	b.Values = values
...
type BulkUpsertOrderCustomAttributesRequest struct {
	...
	Values map[string]*v5.BulkUpsertOrderCustomAttributesRequestUpsertCustomAttribute `json:"values" url:"-"`
...
// SetValues sets the Values field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (b *BulkUpsertOrderCustomAttributesRequest) SetValues(values map[string]*v5.BulkUpsertOrderCustomAttributesRequestUpsertCustomAttribute) {
	b.Values = values
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (u *UpsertOrderCustomAttributeRequest) SetCustomAttribute(customAttribute *v5.CustomAttribute) {
