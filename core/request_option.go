...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("X-Fern-SDK-Name", "github.com/square/square-go-sdk/v40")
	headers.Set("X-Fern-SDK-Version", "v40.0.0-rc.0")
	headers.Set("User-Agent", "github.com/square/square-go-sdk/40.0.0-rc.0")
	return headers
}
