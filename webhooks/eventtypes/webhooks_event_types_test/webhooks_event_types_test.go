...
package webhooks_event_types_test
...
func TestWebhooksEventTypesListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Webhooks.EventTypes.List(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestWebhooksEventTypesListWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestWebhooksEventTypesListWithWireMock", "GET", "/v2/webhooks/event-types", map[string]string{"api_version": "api_version"}, 1)
}
